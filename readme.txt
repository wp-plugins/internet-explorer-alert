...
== Description ==
   Internet Explorer Alert is created to Alert visitor to use Recommended Browser like Firefox, Chrome etc. That is if anyone browse your site with Internet Explorer, he/she will alert by your site to use Recommended web Browser. Also, they will get the Recommended web Browser download link! <strong>By Default, It Detect and Alert for Internet Explorer 8 or later. You can Customize the Internet Explorer Detection by editing this plugin easily.  For More, <a href="http://shariarbd.com/plugins/internet-explorer-alert-v-2-0/" target="_blank">Visit Plugin Site</a>. </strong>  Plugin is created by <cite><a href="http://shariarbd.com" title="Md. Sahriar">Md. Shariar</a>.</cite>
